<template>
  ...
  >
    ...
    >
      ...
      <UserJoinedDate :join-date="user.created_at" />

      <UserBio :bio="user.bio" />

      <UserStats>
        <UserStatItem title="Repos" :content="user.public_repos" />
        <UserStatItem title="Followers" :content="user.followers" />
        <UserStatItem title="Following" :content="user.following" />
      </UserStats>

      <UserSubInfo>
        <UserSubInfoItem :content="user.location">
          <svg
            id="location-icon"
            height="20"
            width="20"
        ...
        <UserSubInfoItem :content="user.twitter_username">
        ...
        <UserSubInfoItem :content="user.blog">
        ...
        <UserSubInfoItem :content="user.company">
          <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
            <g fill="#4b6a9b">
              <path
